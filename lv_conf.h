 ...
 */
    ...
    /*Prefix variables that are used in GPU accelerated operations, often these need to be placed in RAM sections that are DMA
     * accessible*/
    ...
    #define LV_FONT_DEFAULT &FiraSansMedium13
